...
RecipeClient.prototype.findByIngredients = function(ingredients) {
...
RecipeClient.prototype.findByCuisine = function(cuisine) {
	return new Promise((resolve, reject) => {
...
RecipeClient.prototype.getInfoById = function(id) {
	return new Promise((resolve, reject) => {
...
RecipeClient.prototype.getStepsById = function(id) {
	return new Promise((resolve, reject) => {
		var options = {
			hostname: host,
			port: 443,
